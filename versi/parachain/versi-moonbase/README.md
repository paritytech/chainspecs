...
```shell
docker run --rm purestake/moonbeam:v0.26.0 build-spec --chain moonbase-dev > ./moonbase-dev-plain.json
# Fix network name
...
docker run --rm -v $(pwd)/moonbase-dev-plain.json:/moonbase-dev-plain.json purestake/moonbeam:v0.26.0 build-spec --chain /moonbase-dev-plain.json --raw > ./chainspec.json
