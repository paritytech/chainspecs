...
PREFIX=westend-bridge-hub-collator-node-
...
printf "$CHAINSPEC" | jq | sed 's/1e+18/1000000000000000000/' > ./bridge-hub-override.json
printf "${BOOTNODES_KEY_LIST}" | sed 's/-/_/g' > ./bridge-hub_nodekey.yml