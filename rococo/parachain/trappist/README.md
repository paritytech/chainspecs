...
```
DOCKER_IMAGE=paritytech/trappist:polkadot-v0.9.37

# 1. generate base chainspec  
docker run $DOCKER_IMAGE trappist-collator  build-spec --chain trappist-rococo  > ./trappist-base.json

# 2. Merge trappist-base.json and trappist-override.json
jq  -s '.[0] * .[1]'  trappist-base.json trappist-override.json | sed 's/1e+18/1000000000000000000/' > ./chainspec-nonraw.json
